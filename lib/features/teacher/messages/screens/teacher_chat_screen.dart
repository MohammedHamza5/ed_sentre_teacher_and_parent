...
class _TeacherChatScreenState extends State<TeacherChatScreen> {
  ...
  Future<void> _markAsRead() async {
    try {
      await _repo.markMessagesAsRead(widget.conversation.id);
    } catch (e) {
  ...
  void _subscribeToMessages() {
    _subscription = _repo.subscribeToMessages(widget.conversation.id, (
      newMessage,
    ) {
      if (mounted) {
        setState(() {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      } else if (widget.conversation.conversationType ==
